...
def payment(request):
    ...
    store_id = 'abcco5f84992be8ba0'
    API_key = 'abcco5f84992be8ba0@ssl'
    ...
    mypayment.set_product_integration(total_amount=Decimal(order_total), currency='BDT', product_category='Mixed', product_name=order_items, num_of_item=order_items_count,
